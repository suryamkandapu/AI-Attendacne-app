...
from src.database.db import check_teacher_exists, create_teacher, get_attendance_for_teacher, get_teacher_subjects , teacher_login
from src.components.dailog_create_subject import create_subject_dialog
        ...
        if st.button('Run Face Analysis', width='stretch', type='secondary', icon=':material/analytics:', disabled=not has_photos):
            with st.spinner('Deep scanning classroom photos...'):
                ...
                if not enrolled_students:
                    ...
                    attendance_result_dialog(pd.DataFrame(results), attendance_to_log)  # ← inside else
